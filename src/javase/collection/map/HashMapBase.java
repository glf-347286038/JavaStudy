...
public class HashMapBase {
    public static void main(String[] args){
        ...
        //如果加入的长度大于16*0.75 = 12(阈值)  就会触发扩容 再加入值的时候如果出现hash冲突那么就要立即进行扩容
     ...
     * 比如16的二进制表示为10000，那么length-1就是15，二进制位01111，
     * 同理扩容后的数组长度为32，二进制表示为100000，length-1为31，二进制表示为011111。
     * 这样保证低位全为1，而扩容之后只有一位差异，也就是最左边的1,这样通过h&(length-1)的时候，只要h对应的最左边的那一个差异位为0，
